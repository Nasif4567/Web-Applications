...
<h3>Add new Air filter</h3>

<div>
  <form action="InsertAirProcess.php" method="POST" enctype="multipart/form-data">
    <label for="fname">Product Name</label>
    <input type="text" id="name" name="productname" placeholder="Product name" required>

    <label for="lname">Brand</label>
    <input type="text" id="brand" name="productbrand" placeholder="product brand" required>

    <label for="lname">Product size</label>
    <input type="text" id="size" name="productsize" placeholder="product brand"  required>

    <label for="lname">Product price</label>
    <input type="number" id="brand" name="productprice" placeholder="product price" data-type="number" required>

    <label for="lname">Choose product image</label>
    <input type="File" id="file" name="productfile" required>

  
    <input type="submit" value="Add the Air filter">
  </form>
