...
<link rel="stylesheet" href="ContactUSAdminn.css">
...
if(!$_SESSION['Username'])
{
    ...
    if ($count > 0 ) {
        ...
        while($row = $result -> fetch_assoc()) {
            ...
            echo "<tr>      <td>" . $row['Name'] . "</td> <td>"  . $row['Email'] .  "</td>  <td> <form action ='ViewMessage.php' method='post'> <input type='hidden' name='id' value=". $row['Email']. "> <button name = 'btn' type = 'submit' style = 'color:black'>Click here to view message</button> </form> </td>        <td> <form action ='DeleteMessage.php' method='post'> <input type='hidden' name='id' value=". $row['Email']. "> <button name = 'btn' type = 'submit' style = 'color:black'>Delete message</button> </form> </td>         </tr>" ;
        }
